...
<html lang="en">
  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap" style="background-image: url('images/cg_2.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php?ctl=iniciarSesion">Inicio</a></span> <span>Iniciar Sesion</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Iniciar Sesion</h1>
          </div>
        </div>
      </div>
    </div>
...
<div class="container text-center py-2">
	...
	<div class="container text-center p-1">
		...
		<br>	
		<p>Usuario</p>
		<p >* <input  TYPE="text" NAME="user" VALUE="<?php echo $params['user'] ?>" PLACEHOLDER="" tabindex="1" aria-label="introducir nombre" > <br></p>
		<p>Contraseña</p>
		<i>Minimo 12 caracteres, una letra en mayúscula y un número</i>	
		<p id="btnPSW">* <input  id="password2" TYPE="password" NAME="pass" VALUE="<?php echo $params['pass'] ?>" PLACEHOLDER="" tabindex="2" aria-label="introducir contraseña" ><img id="ojo" src="./img/ojoCerrado.png" alt=""><br></p>
