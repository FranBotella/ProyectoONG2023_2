  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php?ctl=inicio">Inicio</a></span> <span>Insertar post</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Insertar post</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="div-perfil container text-center p-1">
        <form id="insertarForm" action="index.php?ctl=insertarP" method="post" enctype="multipart/form-data">
            ...
            <p>Contenido</p>
            <p>* <textarea  name="contenido" rows="20" cols="100"></textarea><br></p>
         <p>Fecha inicio</p>
