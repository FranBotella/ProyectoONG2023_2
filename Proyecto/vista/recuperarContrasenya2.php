      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php?ctl=inicio">Inicio</a></span> <span>Recuperar contraseña</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Recuperar contraseña</h1>
          </div>
        </div>
      </div>
    </div>
...
<div class="container text-center p-1">
    ...
    <?php if($contrasenya!=""){ ?>
      ...
      <p>Minimo 12 caracteres, una letra en mayúscula y un número</p>
    <p>* <input TYPE="text" NAME="contraseñaNueva" VALUE="" PLACEHOLDER="        contraseñaNueva"><br></p>
    <input id="BTN-BTNuevaContrasenya"  TYPE="submit" NAME="bNuevaContrasenya" VALUE="Confirmar"><br> 
    </form>  
    </div>
<?php }?>
