...
echo "<div id='formularios'>";
    ...
    echo "<input role='button' tabindex='1' aria-label='confirmar compra si no se ha seleccionado boton quitar compra,sino eliminara producto y no se habra confirmado compra'  TYPE='submit' NAME='bCarrito' id='bCarrito1' class='btn btn-danger' VALUE='Confirmar'>";
