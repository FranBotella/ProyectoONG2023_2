...
<html lang="en">
  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap" style="background-image: url('images/dg_2.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php?ctl=inicio">Inicio</a></span> <span>Registrarse</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Registrarse</h1>
          </div>
        </div>
      </div>
    </div>
...
<div class="container text-center py-2">
	...
	<div class="container text-center p-1">
		<form id="formuRegistro" ACTION="index.php?ctl=registro" METHOD="post" NAME="formRegistro">
			<br>
			<p>Usuario</p>
			<p>* <input tabindex="1" TYPE="text" NAME="user" VALUE="<?php echo $params['user'] ?>" PLACEHOLDER="" aria-label="introducir usuario"> <br></p>
			<p>Contraseña</p>
			<i>Minimo 12 caracteres, una letra en mayúscula y un número</i>
			<p id="btnPSW">* <input tabindex="2" id="password" TYPE="password" NAME="pass" VALUE="<?php echo $params['pass'] ?>" PLACEHOLDER="" aria-label="introducir contraseña"><img id="ojo2" src="./img/ojoCerrado.png" alt=""><br></p>
		<!-- <input type="button" id="ojo2" value="Mostrar/ocultar contraseña"></input> -->
		
			<p>Email</p>
			<p>* <input tabindex="3" TYPE="text" NAME="email" VALUE="<?php echo $params['email'] ?>" PLACEHOLDER="" aria-label="introducir email"><br></p>
			<div id="BTNregistro">
				<div class="botones">
					<div >
