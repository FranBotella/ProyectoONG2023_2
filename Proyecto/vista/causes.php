    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="index.php?ctl=causas" class="nav-link">Causas</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php?ctl=causas">Inicio</a></span> <span>Causas</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Causas</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section">
      <div class="container">
      	<div class="row">
            ...
            <a href="#" class="img" style="background-image: url(images/comedorSocial.jpg);"></a>
    					<div class="text p-3 p-md-4">
              <h3 tabindex="1"><a href="#">Comedor Social</a></h3>
      		...
      		<div class="col-md-4 ftco-animate">
      			<div class="cause-entry">
    				<a href="#" class="img" style="background-image: url(img/root/108.jpg);"></a>
    					<div class="text p-3 p-md-4">
              <h3 tabindex="2"><a href="#">Senegal</a></h3>
      		...
      		<div class="col-md-4 ftco-animate">
      			<div class="cause-entry">
            <a href="#" class="img" style="background-image: url(img/root/055.jpg);"></a>
    					<div class="text p-3 p-md-4">
              <h3 tabindex="3"><a href="#">Asociacion</a></h3>
